...
-export([video_db_url/0, 
		 ...
		 % world_news_top_text_news_with_limit/2,
...
videos_latest() ->
	...
	string:concat(?MODULE:video_db_url(), "_design/video_world_news/_view/by_id_title_desc_thumb_date?descending=true&limit=5")
.
...
.
% world_news_top_text_news_with_limit(Category,Limit) ->
% 	%% http://localhost:5984/wildridge/_design/news_by_category/_view/us_news?descending=true&limit=10
% 	Url1 = string:concat(?MODULE:news_db_url(), "_design/text_us_world/_view/" ),
% 	Url2 = string:concat(Url1, Category),
% 	Url3 = string:concat(Url2, "?descending=true&limit="),
% 	string:concat(Url3, Limit)
% .
